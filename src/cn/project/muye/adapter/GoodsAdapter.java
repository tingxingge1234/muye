...
public class GoodsAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder>{
    ...
    public GoodsAdapter(Context context, ArrayList<NewGoodBean> mNewGoodList) {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        switch (viewType) {
            case TYPE_ITEM:
                layout = filter.inflate(R.layout.item_good, parent, false);
...
//        });
    ...
    class GoodItemViewHolder extends RecyclerView.ViewHolder {
        ...
        public GoodItemViewHolder(View itemView) {
            super(itemView);
            mAvatar = (NetworkImageView) itemView.findViewById(R.id.niv_good);
            mtvGoodName = (TextView) itemView.findViewById(R.id.tv_good_name);
            mtvPrice = (TextView) itemView.findViewById(R.id.tv_price);
            rl_good = (RelativeLayout) itemView.findViewById(R.id.rl_good);
