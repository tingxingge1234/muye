...
//    String SERVER_ROOT="http://139.196.185.33:8080/FuLiCenterServer/Server";
	...
	String REQUEST_DOWNLOAD_AVATAR_USER					=	MuYeApplication.SERVER_ROOT+"?"+KEY_REQUEST+"="+REQUEST_DOWNLOAD_AVATAR+"&"+AVATAR_TYPE+"=";
    ...
    /** 下载分类商品大类图像的接口*/
    String DOWNLOAD_DOWNLOAD_CATEGORY_GROUP_IMAGE_URL= MuYeApplication.SERVER_ROOT+
    ...
    /** 下载收藏商品图像的接口*/
    String DOWNLOAD_GOODS_THUMB_URL= MuYeApplication.SERVER_ROOT+
    ...
    /** 下载分类商品小类图像的接口*/
    String DOWNLOAD_DOWNLOAD_CATEGORY_CHILD_IMAGE_URL= MuYeApplication.SERVER_ROOT+
    ...
    /**壹收款服务端支付URL*/
    String PAY_URL= MuYeApplication.SERVER_ROOT+"?request="+I.REQUEST_PAY;
